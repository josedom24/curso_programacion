...
//Análisis
//Tenemos que leer la longitud de los dos catetos y calcular la hipotenusa. (Teorema de Pitágoras)
...
//Por lo tanto la hipotenusa es igual a la raíz cuadrada de la suma de los cuadrados de los catetos.
