...
// Análisis
// El precio final del autobús depende del número de alumnos que participan en la actividad.
...
// Si son menor de 30 alumnos, el autobús vale 4000 euros, divido por el número de alumnos sabemos cuanto paga cada uno.
...
// 6. Si el número de alumnos > 0 (valor correcto) calculo coste_autobus=número alumnos * coste por alumno y muestro coste_autobus coste por alumnos.
