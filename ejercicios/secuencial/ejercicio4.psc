//Dados dos nÃºmeros, mostrar la suma, resta, división y multiplicación de ambos.
//Análisis
...
//Variables: num1, num2 (Real). Considero que las salidas no es necesario guardarla en variables.
//Diseño
//1. Leer los números
...
Proceso Calcular
	...
	Escribir Sin Saltar "Introduce el nÃºmero 1:";
	Leer num1;
	Escribir Sin Saltar "Introduce la nÃºmero 2:";
	Leer num2;
