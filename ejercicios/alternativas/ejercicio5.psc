...
// Análisis
// Pedimos por teclado nombre y contraseña y si coinciden con las correctas indicamos que se ha entrado en el sistema.
...
// 1. Leer el usuario
// 2. Leer el password
// 3. Si el usuario es igual a "pepe" y el password es igual a "asdasd" escribir "Has entrado en el sistema"
