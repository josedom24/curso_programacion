//Dado un número de dos cifras, diseÃ±e un algoritmo que permita obtener el número invertido. 
//Análisis
//Se pide un número de dos cifras y se debe mostrar el número de centenas y de unidades
...
//Diseño
//1. Leer el número de dos cifras (en estos momentos no podemos determinar que el número es de dos cifras)
