...
//Análisis
//Tenemos que pedir la hora de salida (hora, minutos y segundos) Tengo que saber también el tiempo en segundo que ha tardado en llegar. Tenemos que calcular la hora de llegada.
//Datos de entrada: hora, minutos y segundos de salida (entero), segundos que tarda (entero)
//Información de salida: hora, minutos y segundos de llegada (enteros)
//Variables: horapartida, minpartida, seglpartida, segviaje, horallegada, minllegada, segllegada (enteros)
//Diseño
