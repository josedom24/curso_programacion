//################################################################################
//Mostrar en pantalla los N primero n\ufffdmero primos. Se pide por teclado la cantidad 
...
//todos impares. Voy probando desde el 3 todos los impares hasta que muetre la 
//cantidad que hemos indicados (necesito un contador).
//Para comprobar si son primos, los voy dividiendo desde 3 hasta la raíz cudrada
...
//3.- Incializo el contador de número mostrados a 1.
//4.- Incializo la variable donde guardo el número a proabar -> num=3
//4.- Mientras no haya mostrado la cantidad de número indicados
//		5.- Considero que es primo. Incializo el indicador -> es_primo=Verdadero
//		6.- desde el 3 hasta la raíz cuadrada del número
//			7.- Si es divisible -> Ya no es primo -> es_primo=Falso
//		8.- Si es primo
//			9.- Incremoento el contador de números mostrados
...
Proceso Primos
    ...
    Mientras cant_mostrados<cant_a_mostrar Hacer
        ...
        Para divisor<-3 hasta rc(num) con paso 2 Hacer // ya sabemos que es impar
            Si num % divisor = 0 entonces // si la division da exacta...
