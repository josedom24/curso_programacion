...
// Análisis
// Pedimos por teclado una cadena y hay que comprobar que todas las letras sean mayúsculas.
// Datos de entrada: cadena (cadena)
// Información de salida: Mensajes de es mayúsculas o no es mayúsculas.
// Variables: cadena (cadena)
// Diseño
// 1. Leer la cadena
// 2. Si la cadena es igual a la cadena convertida en mayúsculas, mostrar "La cadena es mayúsculas"
