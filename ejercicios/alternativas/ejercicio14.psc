...
// Análisis
// El precio final de la uva se calcula multiplicando los kilos recogidos por el precio de cada kilo. el precio por kilo 
// se calcula a partir de un precio inicial sumando o restando una cantidad determinada según el tamaño y el tipo de la uva.
// Datos de entrada: tipo,tamaño (carácter), precio inicial en céntimos y kilos (entero)
// Información de salida: Precio final en euros (real) o mensaje de error
// Variables: precio_inicial (entero), kilos (entero), tamano (carácter), tipo (carácter), precio_final (real)
// Diseño
