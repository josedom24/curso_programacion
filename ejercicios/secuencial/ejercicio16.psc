...
//El que está detrás viaja a una velocidad mayor. Se pide hacer un algoritmo para ingresar la distancia entre los dos vehículos (km) y sus respectivas velocidades (km/h) 
//y con esto determinar y mostrar en que tiempo (minutos) alcanzará el vehículo más rápido al otro.
//Análisis
//Hay que saber la velocidad de cada vehículo, y la distancia entre ambos, y calcular el tiempo que tardará el que está detrás (y va más rápido) al primero.
